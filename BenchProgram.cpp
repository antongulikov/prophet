...
/**
 * Build the project in subDir using build_cmd. Doing it lazy and once, then just incBuild it.
 * @param subDir
 * @param timeout_limit
 * @param force_reconf
 * @return
...
/**
 * Run tests in case_set with env vars from env_pairs and pass -p if pass_basic_src_dir.
 * @param subDir
 * @param case_set
 * @param env_pairs
 * @param pass_basic_src_dir
 * @return positive case_set
 */
